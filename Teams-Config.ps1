...
while ($true) {
    $choice = Read-Host "Enter your choice number (1-4), 'm' to show menu, 'q' to quit, or 'c' to clear the console"
    ...
    switch ($choice) {
        ...
        default {
            Write-Host "`nInvalid choice. Please enter a number between 1 and 4, 'm' to show menu, 'q' to quit, or 'c' to clear the console."
        }
    }
